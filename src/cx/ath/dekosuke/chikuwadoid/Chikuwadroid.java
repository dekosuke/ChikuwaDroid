...
public class Chikuwadroid extends Activity implements Runnable {
	...
	private ArrayList<LiveStream> streams = null;
	...
	public void setWait() {
		...
		/*
		 * try { sortType = StateMan.getSortParam(this); } catch (Exception e) {
		 * FLog.d("message", e); }
		 */
	...
	public void checkCache() {
		...
		try {
			...
			// Toast.makeText(this, "画像キャッシュ整理中...", Toast.LENGTH_SHORT).show();
